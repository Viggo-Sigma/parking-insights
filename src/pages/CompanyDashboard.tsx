...
const CompanyDashboard = () => {
  ...
  return (
    <div className="space-y-8">
      <div 
        className={`bg-gradient-to-r from-white to-blue-50 rounded-xl shadow-lg p-8 border border-blue-100 transform transition-all duration-700 ${
      ...
      <div className={`bg-gradient-to-r from-white to-blue-50 rounded-xl shadow-lg p-8 border border-blue-100 transition-all duration-700 delay-450 transform ${
        isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
      }`}>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg shadow-inner">
          <h3 className="text-xl font-medium text-blue-800 mb-3">Key Features:</h3>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
            {[
              ...
              <li key={index} className="flex items-center space-x-2 text-blue-700 transition-all duration-300 hover:translate-x-1">
